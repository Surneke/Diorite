      ...
      <div className="pt-[210px] xl:pt-[136px] lg:pt-[110px] md:pt-[130px]">
          ...
          <InView threshold={0} trackVisibility delay={1000} triggerOnce>
            {({ inView, ref }) => (
              <>
                <div
                  ref={ref}
                  className={`duration-[1s] delay-[0.6s] ${
                ...
                >
                  <div
                    id="full-img"
                    className="px-[60px] h-[80vh] pt-[70px] xl:px-[30px] lg:pt-[40px] md:pt-[30px]"
                  >
                    <img
                      style={{
                        scale: inView ? "1" : "0.1",
            ...
            <div className={`w-full flex relative`}>
              <div id="sticky" className="w-[50%] pt-[150px] sticky top-0 ">
                <h2 className="text-[28px] h-[100px] leading-[27px] duration-[.1s] text-[#fff]">
                  No Harm to
                  <p className="text-[64px] pt-[12px] text-[#B58765] leading-[62px] font-semibold">
                    The Earth
                  </p>
                </h2>
                <h3
                ...
                >
                  DIORITE is a brand that promotes smart consumption and
                  ecological balance. Minimalism and simplicity are reflected in
                  our products. Control the selection of materials at a high
                  level and calculate the process from how it is produced to how
                  it is absorbed into nature Conduct production with less waste
                  and introduce the process of recycling waste into our
                  operations Creating quality by combining standards and
                  technology.
                </h3>
              </div>
              <div className="w-[50%] flex gap-x-[24px] overflow-hidden">
                <div
                  id="first"
                  className="max-w-[435px] flex flex-col gap-y-[24px] mt-[-654px] "
                >
                  {[
                    "/static/_0000327.jpg",
                    "/static/_0000382.jpg",
                    ...
                    <div className="w-full h-[630px]" key={i}>
                      <img
                        className="object-cover w-[435px] h-full rounded-xl"
                        src={el}
                        alt=""
                      />
                    </div>
                ...
                <div
                  id="second"
                  className="max-w-[435px] flex flex-col gap-y-[24px] mt-[-300px]"
                >
                  {[
                    "/static/_0000803.jpg",
                    "/static/_0000272.jpg",
          ...
          <div className="py-[160px] px-[60px] flex justify-center items-center xl:px-[30px] xl:py-[130px] sm:py-[70px]">
            <div className="max-w-[1496px] w-full h-[100vh] max-h-[847px] relative xl:max-h-[538px] lg:max-h-[387px]">
              <div className="flex h-full">
                <img
                  className="object-cover object-center w-full rounded-xl xl:object-[50%_40%]"
                  src="/static/_0000126.jpg"
                  alt=""
                />
              </div>
        ...
        <section className="max-w-[1920px] mx-auto">
          <TitleDescription
            ...
            colorDec="text-description"
          />
          <div className="flex w-full justify-center gap-x-[24px] p-[10px_60px_160px] xl:grid xl:grid-cols-[minmax(360px,_560px)_minmax(166px,_366px)] xl:grid-rows-2 sm:grid-cols-1 xl:gap-[16px] xl:p-[65px_30px_130px] sm:grid-rows-[minmax(300px,_500px)] sm:gap-[24px] sm:p-[65px_30px_100px] mt-10">
            {[
              {
                src: "/static/_0000092.jpg",
                type: "Limited edition",
                feature:
                  "DIORITE is a brand that promotes smart consumption and ecological balance.",
              },
              {
                ...
                className={`relative max-h-[780px] xl:max-w-[100%] ${
                  i === 1
                    ...
                    : ` w-1/4 mt-[-60px] xl:w-[100%] xl:mt-0 xl:max-w-[366px] xl:max-h-[332px] sm:max-w-none sm:max-h-[500px] h-[auto] ${
                        i === 2 &&
                        " xl:col-start-2 xl:row-start-1 sm:col-start-auto sm:row-start-auto sm:max-h-[500px] sm:h-[500px]"
                      }`
                }`}
                key={i}
              >
