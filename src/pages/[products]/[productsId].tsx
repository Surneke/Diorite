    ...
    <div className="pt-[140px]">
      <section className="max-w-[1920px] m-auto grid grid-cols-3 gap-[24px] relative ">
        <div className="max-w-[280px] sticky top-0 right-0 ml-[35%]">
          <h2 className="text-[24px] leading-[42px] mb-[20px] pt-[250px]">
            Materials And Care
          </h2>
          <h2 className="text-[20px] leading-[35px] mb-[5x]">Materials</h2>
          <h3 className="text-[16px] leading-[22px] pb-[16px]">
            We work with monitoring programmes to ensure compliance with our
            social, environmental and health and safety standars for our
        ...
        <div className="max-w-[280px] ">
          <h2 className="text-[24px] leading-[42px] pt-[250px]">
            Basic Leather coat
          </h2>
          <h3 className="text-[16px] pt-[20px] leading-[22px]">
            Long coat made of a leather material. Lapel collar and long sleeves
            with adlustable tabs and buttons. Tie belt in same fabric.
          </h3>
        </div>
      </section>
